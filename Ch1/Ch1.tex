...
So that's a vector space! Not too complicated, right? Vector spaces are really just a collection of vectors with a few important properties. Let's move on to a few more definitions about them before moving on to the real heart of linear algebra:  linear transformations.
